<div class="container">
    ...
    <div class="table-responsive overflow-hidden">
        ...
        <table class="table table-striped custom-table" id="custom-table">
            <thead>
                <tr>
                    <th scope="col"class="pb-3 text-center px-3"> <span>Delete</span></th>
                    <th scope="col" class="p-0">
                        <div class="d-flex justify-content-between ">
                            <span class="p-3">Header 1</span>

                            <div class="btn-group  ">
                                <button class="btn bg-transparent border-0" type="button" id="dropdownMenuClickable"
                                    data-bs-toggle="dropdown" data-bs-auto-close="false" aria-expanded="false">
                                    <i class="fa-solid fa-caret-down  text-white"> </i>
                                </button>
                                <ul class="dropdown-menu filterSection p-3" aria-labelledby="dropdownMenuClickable">
                                    <div class="px-2">

                                        <span style="letter-spacing: normal;   text-transform: capitalize!important;"
                                            class="fs-6 fw-lighter">Sort By</span>
                                        ...
                                        <span style="letter-spacing: normal;   text-transform: capitalize!important;"
                                            class="fs-6 fw-lighter">Filter By</span>
                                        <div class="d-flex mt-2">
                                            <select class="filterOptions" multiple data-placeholder="select here..."
                                                style="width: 240px">
