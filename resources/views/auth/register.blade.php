            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            <label for="ldate" class="col-md-4 col-form-label text-md-end">{{ __('Lisense Date') }}</label>

                            <div class="col-md-6">
                                <input id="ldate" type="date" class="form-control @error('ldate') is-invalid @enderror" name="ldate" value="{{ old('ldate') }}" required autocomplete="ldate">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="permission" type="text" class="form-control @error('permission') is-invalid @enderror" name="permission" value="{{ old('permission') }}" required autocomplete="permission">
